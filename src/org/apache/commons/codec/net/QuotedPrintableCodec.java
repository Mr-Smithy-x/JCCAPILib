 ...
 * </ul>
 * Originally, this class only supported the non-strict mode, but the org.apache.commons.codec in this partial form could already be used
 * for certain applications that do not require quoted-printable line formatting (rules #3, #4, #5), for instance
 * Q org.apache.commons.codec. The strict mode has been added in 1.10.
 * <p>
