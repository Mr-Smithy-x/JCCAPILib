...
abstract class RFC1522Codec {
    ...
    protected String decodeText(final String text)
        ...
        if (!getEncoding().equalsIgnoreCase(encoding)) {
            throw new DecoderException("This org.apache.commons.codec cannot decode " + encoding + " encoded content");
        }
        from = to + 1;
        to = text.indexOf(SEP, from);
    ...
    /**
     * Returns the org.apache.commons.codec name (referred to as encoding in the RFC 1522).
     *
     * @return name of the org.apache.commons.codec
     */
